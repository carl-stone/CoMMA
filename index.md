...
![Mean methylation across gene bodies (TSS = 0 to TTS =
1).](reference/figures/README-plot-metagene-1.png)
...
![Genome track for the first 10 kb of
chr_sim](reference/figures/README-plot-track-1.png)
...
sites.](reference/figures/README-plot-heatmap-1.png)
...
profile.](reference/figures/README-plot-tss-1.png)
...
A single `commaData` object can hold 6mA, 5mC, and 4mC sites
simultaneously. The `mod_type` argument is available on every analysis
function:
...
| 0.6.0 | M-value PCA, [`motifs()`](https://carl-stone.github.io/comma/reference/motifs.md) accessor | ✅ Complete |
| 0.7.x | [`plot_tss_profile()`](https://carl-stone.github.io/comma/reference/plot_tss_profile.md), `diffMethyl(method="limma"|"quasi_f")` | ✅ Complete |
| 0.8.0 | `mod_context` rowData column, [`modContexts()`](https://carl-stone.github.io/comma/reference/modContexts.md), per-context DM testing | ✅ Complete |
| 0.9.x | [`enrichMethylation()`](https://carl-stone.github.io/comma/reference/enrichMethylation.md), GO/KEGG ORA + GSEA, offline KEGG path | ✅ Complete |
