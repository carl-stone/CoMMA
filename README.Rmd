...
- **Differential methylation** — inference using two methods 
  ([`methylKit`](https://doi.org/doi:10.18129/B9.bioc.methylKit) or a 
  quasibinomial GLM per site), with a DESeq2-style interface (`diffMethyl()` → 
...
A built-in synthetic dataset (300 sites, 6 samples, 100 kb genome) is included
